...
# a vector may consist of 1 elemnent or multiple
# elements
...
# create 3 vectors all od the same length
vnumeric <- c(1,2,3)
vcharacter <- c("a", "b", "c")
vlogical <- c(T,F,T)
...
# data structure in R because the data values in them
# may ne of any data type and the data structures in
