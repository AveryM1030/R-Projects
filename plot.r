...
# statisticial analysis, you must have data

# The datasets R base package contains
#data that may be used for statistical analysis.

# Built in the satasets package are various 
# data frames upon which analysis may be
# performed.
...
# function, data fram, etc. you use
# the ?

# get listing of all data frams in
# datasets package
...
# show the first six rows of the iris data
# frame
head(iris)

# the iris data frame has 5 different variables:
# Species is a categorical variable (represents
...
# and charts and then you look at the numbers available
...
# x-axis is telling use that we have 50 data points in groupings
# y-axis is telling us that petal length for the data points
plot(iris$Petal.Length)

# give plot function 1 categorical variable and 2 quantitative
# variable
...
# give plot function 2 quantitiative variables and other
...
plot(iris$Petal.Length, # data points for x-axis
    ...
    main = "Iris: Petal Length bs. Petal Width", # main title
